...
## 3.1 Project specific documents

In addition to the canonical documents, each project will have project specific documents, that detail project specific details. These are located in a project folder here:
/
├─ docs/
   ├─ project/

Review all content in this folder. use if for specific project requirements
