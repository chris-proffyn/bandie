...
### 6.3 Multi-tenant architecture
 ...
 - For many projects a single database hosting multiple projects will suffice
 - Read the document: RSD_SUPABASE_MULTI_TENANT_DB.md
 - This is a key design decison. Ask the user if this is to be used before starting development
