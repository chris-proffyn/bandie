-- Band lineup parts, leader contact fields, and player outreach invites
...
-- Band parts: members read, leaders manage
...
-- Player outreach: leaders manage their band outreach
